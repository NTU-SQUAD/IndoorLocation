...
if __name__ == "__main__":
    ...
    for path_filename in path_filenames:
        ...
        plt.savefig("{}/{}.png".format(path_image_save_dir, path_id), dpi=300, transparent=True)
        plt.clf()
        plt.close()
    ...
    plt = visualize_heatmap(heat_positions, heat_values, floor_plan_filename, width_meter,
                            height_meter, colorbar_title='mu tesla', title='Magnetic Strength', show=False)
    plt.savefig("{}/magnetic_strength.png".format(magn_image_save_dir), dpi=300, transparent=True)
    plt.clf()
    plt.close()
    ...
    plt = visualize_heatmap(heat_positions, heat_values, floor_plan_filename, width_meter,
                            height_meter, colorbar_title='dBm', title=f'Wifi: {target_wifi} RSSI', show=False)
    plt.savefig("{}/{}.png".format(wifi_image_save_dir, target_wifi.replace(":", "-")), dpi=300, transparent=True)
    plt.clf()
    plt.close()
